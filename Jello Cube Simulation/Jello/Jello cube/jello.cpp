...
void showInclinedPlane()
{
    ...
    // Find four points lying on the plane within the bounding box
    // Picking points with x = ±size and y = ±size, solving for z using the plane equation

    v1.x = -size;
    v1.y = -size;
    v1.z = (-jello.d - jello.a * v1.x - jello.b * v1.y) / jello.c;


    v2.x = size;
    v2.y = -size;
    v2.z = (-jello.d - jello.a * v2.x - jello.b * v2.y) / jello.c;

    v3.x = size;
    v3.y = size;
    v3.z = (-jello.d - jello.a * v3.x - jello.b * v3.y) / jello.c;

    v4.x = -size;
    v4.y = size;
    v4.z = (-jello.d - jello.a * v4.x - jello.b * v4.y) / jello.c;

    // Drawing the inclined plane as a quadrilateral
...
void myinit()
{
  ...
  glClearColor(0.529f, 0.808f, 0.918f, 0.0);
...
void display()
{
  ...
  */
  ...
  GLfloat mKa[] = { 0.2, 0.1, 0.0, 0.6 };  // Ambient - dark orange
  GLfloat mKd[] = { 0.8, 0.4, 0.0, 0.6 };  // Diffuse - bright orange
  GLfloat mKs[] = { 1.0, 0.9, 0.8, 1.0 };  // Specular - slightly warm white
  GLfloat mKe[] = { 0.2, 0.1, 0.0, 1.0 };  // Emission - slight orange glow
  ...
  float skyboxVertices[] = {
      ...
      -1.0f, -1.0f, -1.0f,
       ...
       1.0f,  1.0f, -1.0f,
      -1.0f,  1.0f, -1.0f,
      // ... (add all 36 vertices for full cube)
  };
